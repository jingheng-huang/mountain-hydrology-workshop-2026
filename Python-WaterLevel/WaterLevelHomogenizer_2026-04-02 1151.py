    ...
    def concatenate_series_with_baselevel(self, station):
        ...
        for i, seg in enumerate(segments):
            ...
            if base_level is not None and base_lvl_date is not None:
                ...
                # TODO: cannot remember what this was about - station moved presumably?
...
# TODO - remove all functions to separate file and use import

h = WaterLevelHomogenizer("params_simple_2026-04-02.yml")
#h = WaterLevelHomogenizer("params_simple_2025-11-25T0040.yml")


stations = ["KG_G354-new","KG_G354-old"]
...
h.plot_ts_multi_years(h,cat_df, station, close=True)
# #
